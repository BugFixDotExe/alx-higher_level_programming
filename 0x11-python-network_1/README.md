...
libraries to send and receive HTTP messages to URL's. I the solution that follo below were posed at me, with the aim of applying what i learnt on sending `GET`
